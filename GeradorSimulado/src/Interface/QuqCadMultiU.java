...
public class QuqCadMultiU extends JPanel {
    ...
    public QuqCadMultiU(QuestaoQcadastro q) {
        ...
        labelmu = new JLabel("           Multipla escolha com Resposta Unica");
        ...
        ok.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                painelb.setVisible(false);
                for (int i = 0; i < a; i++) {
                    painelGrid[i] = new JPanel();
                    painelGrid[i].setBorder(new LineBorder(new Color(0, 0, 0), 2));
                    painelGrid[i].setLayout(null);
                    ...
                    painelGrid[i].add(sc[i]);
                    rd[i].setText("Alternativa " + i);
                    painelGrid[i].add(rd[i]);
                    painelb.add(painelGrid[i]);
                    bg.add(rd[i]);
                    painelb.setVisible(true);
