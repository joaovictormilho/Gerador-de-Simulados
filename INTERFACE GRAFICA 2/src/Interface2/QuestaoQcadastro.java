...
public class QuestaoQcadastro extends JPanel{
	...
	private JComboBox<String> boxassunto, boxtipoq;
	...
	QuestaoQcadastro(APainelinterface a){
		//Painelcentral
		//painelc = new JPanel();
		...
		labelcad = new JLabel("Cadastrar Questão");
		...
		add(labelassunto);
		//Texto tipo questao
		labeltipo = new JLabel("Tipo de Questão");
		labeltipo.setBounds(250,70,150,40);
		//painelc.add(labeltipo);
		//Box do assunto
		boxassunto = new JComboBox<String>();
